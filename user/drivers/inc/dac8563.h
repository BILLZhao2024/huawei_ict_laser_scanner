...
#define DAC8563_USE_SPI_HW 1

#if DAC8563_USE_SPI_HW
#define DAC8563_SPI hspi1
#else
#define SCLK_H      GPIO_FAST_SETBIT(A,5)
#define SCLK_L      GPIO_FAST_RESETBIT(A,5)

#define DIN_H       GPIO_FAST_SETBIT(A,7)
#define DIN_L       GPIO_FAST_RESETBIT(A,7)
#endif

#define SYNC_H      GPIO_FAST_SETBIT(A,4)
#define SYNC_L      GPIO_FAST_RESETBIT(A,4)

#define LDAC_H      GPIO_FAST_SETBIT(A,3)
#define LDAC_L      GPIO_FAST_RESETBIT(A,3)

#define CLR_H       GPIO_FAST_SETBIT(A,6)
#define CLR_L       GPIO_FAST_RESETBIT(A,6)
